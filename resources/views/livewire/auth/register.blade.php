        ...
        <div class="h-screen flex justify-center items-center">
            ...
            <form action="" class="w-[500px]" wire:submit='register'>
                <div class="flex justify-between">
                    <div class=" mb-2">
                        <h1 class="text-xl font-bold">Novelty Hostel | Register</h1>
                ...
                <div class="mb-3">
                    <button class="btn bg-orange-400 w-full text-white hover:bg-orange-500" wire:model='submit'>Create</button>
                </div>

                <div class="mb-3">
                    <p class="text-center">---- OR ---- </p>
                    <p class="text-center">Already have an account? <a href="{{ route('login') }}" wire:navigate
                            class="text-orange-400 font-bold">login</a></p>
